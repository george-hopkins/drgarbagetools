 ...
 *
 *  @version $Revision$
 *  $Id: MinHeightCommand.java 1523 2012-04-13 14:34:24Z Sergej Alekseev $
 */
public class MinHeightCommand extends Command {
	 ...
	 */
	public MinHeightCommand(List editParts) {
		super();
	...
	public void redo() {
		...
		for(int i = 0; i < models.size(); i++){
			vb = models.get(i);
			newDimension = new Dimension(vb.getSize().width, min);
