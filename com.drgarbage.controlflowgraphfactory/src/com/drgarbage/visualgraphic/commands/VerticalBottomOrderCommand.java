 ...
 * $Id: VerticalBottomOrderCommand.java 1523 2012-04-13 14:34:24Z Sergej Alekseev $
 */
public class VerticalBottomOrderCommand extends Command {
	 ...
	 */
	public VerticalBottomOrderCommand(List editParts) {
		super();
	...
	public void redo() {
		...
		for(int i = 0; i < models.size(); i++){
			vb = models.get(i);
			newLocation = new Point(vb.getLocation().x, max - vb.getSize().height );
