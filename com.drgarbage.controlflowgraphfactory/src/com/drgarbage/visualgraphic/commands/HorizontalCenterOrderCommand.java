 ...
 *  $Id: HorizontalCenterOrderCommand.java 1523 2012-04-13 14:34:24Z Sergej Alekseev $
 */
public class HorizontalCenterOrderCommand extends Command {
	 ...
	 */
	public HorizontalCenterOrderCommand(List editParts) {
		super();
	...
	public void redo() {
		...
		/* set new locations */
		int newX = min + ((max - min) / 2);
		Point newLocation = null;
		for(int i = 0; i < models.size(); i++){
			vb = models.get(i);
			newLocation = new Point(newX - vb.getSize().width/2, vb.getLocation().y);
