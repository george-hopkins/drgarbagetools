...
/**
 * Cell Editor Locator for the basic block element.
 *  
 * @author Sergej Alekseev
 * @version $Revision:214 $
 * $Id:CommentCellEditorLocator.java 214 2007-06-13 17:41:49Z aleks $
 */
final public class BasicBlockCellEditorLocator implements CellEditorLocator
{

	private BasicBlockFigure stickyNote;
	
	public BasicBlockCellEditorLocator(BasicBlockFigure stickyNote) {
		setLabel(stickyNote);
	}
	 ...
	 */
	protected BasicBlockFigure getLabel() {
		return stickyNote;
	}
	 ...
	 */
	protected void setLabel(BasicBlockFigure stickyNote) {
