...
import com.drgarbage.visualgraphic.commands.VerticalTopOrderCommand;
...
public class VerticalTopOrderAction extends OrderAbstractAction {
	...
	public static String ID = "com.drgarbage.controlflowgraphfactory.actions.vertical_top_order";
	private static String text = ControlFlowFactoryMessages.VerticalTopOrderAction_Text;
	private static String toolTipText = ControlFlowFactoryMessages.VerticalTopOrderAction_ToolTipText;

	public VerticalTopOrderAction() {
		super(ID, text);
		setToolTipText(toolTipText);	
		setImageDescriptor(ControlFlowFactoryResource.vertical_top_order_16x16);
	}
	...
	public void run() {
		if(editor != null){			
			VerticalTopOrderCommand cmd = new VerticalTopOrderCommand(editor.getGraphicalViewer().getSelectedEditParts());
