...
/**
 * Action for generation of the basicblock graph from the byte code
 *
 * @author Sergej Alekseev
 * @version $Revision: 1523 $
 * $Id: GenerateBasicblockGraphAction.java 1523 2012-04-13 14:34:24Z Sergej Alekseev $
 */
public class GenerateBasicblockGraphAction extends GenerateGraphAction {

	public GenerateBasicblockGraphAction() {
	...
	protected ControlFlowGraphDiagram createDiagram( String[] classPath, String mPackage, String mClassName, String mMethodName, String mMethodSignature){
		...
		try {
			controlFlowGraphDiagram = ControlFlowGraphDiagramFactory.buildBasicblockGraphDiagram(classPath, mPackage, mClassName, mMethodName, mMethodSignature);
