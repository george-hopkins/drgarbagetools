 ...
 * It uses a token scanner to scan the document and to determine its damage and new text 
 * presentation. The tokens returned by the scanner are supposed to return text attributes 
 * as their data.
 * 
